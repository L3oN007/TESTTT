...
export default function Hpbietthu() {
    return (
        <div>
            ...
            <div class="container text-center">
                <h1 class="mt-3 display-7">
                    Báo giá Thi công nội thất Biệt Thự trọn gói 2024
                </h1>
            </div>
            <div className="banner-time">
                <span>
                    <time dateTime="25-1-2024">29/02/2024</time>
                    <div>
            ...
            <div className="main-container">
                <div className="contain-items tc-main">
                    ...
                    <p><strong>Thiết kế nội thất Biệt Thự</strong> là một trong những xu hướng thiết kế nhận được sự quan tâm của chủ đầu tư công trình xây dựng.
                        Các căn biệt thự biến hiện nay với đa dạng phong cách khác nhau từ hiện đại, tân cổ điển cho đến cổ điển,…
                        Tùy theo sở thích, gia chủ có thể chọn kiểu không gian mở, sử dụng chất liệu mới hay đi theo lối tối giản, thông minh,…
                        Cùng G7 tham khảo nhiều mẫu thiết kế nội thất nhà ở, biệt thự đẹp, hiện đại để có lựa chọn lý tưởng cho không gian sống bạn nhé!</p>
                    <h4><strong>Các phong cách thiết kế nội thất biệt thự được ưa chuộng hiện nay</strong></h4>
                    <p>Các thiết kế nội thất được ưa chuộng nhất ngày nay bao gồm:</p>
                    
                    <h5>Thiết kế nội thất biệt thự hiện đại </h5>
                    <p>Thiết kế biệt thự theo phong cách thiết kế nội thất hiện đại hướng đến việc mở rộng không gian tối đa và loại bỏ các chi tiết rườm rà.
                        Việc phân chia bố cục cũng đòi hỏi thật hợp lý, đảm bảo đơn giản nhưng vẫn sang trọng và có giá trị thẩm mỹ cao.</p>
                    <img className="img-wrapper" src="./assets/img-thicong/bt2.jpg"></img>
                    ...
                    <p className="text-center">Mẫu phòng khách biệt thự được thiết kế theo phong cách nội thất hiện đại, sang trọng</p>
                    <img className="img-wrapper" src="./assets/img-thicong/np4.jpg"></img>
                    <p className="text-center">Mẫu phòng ngủ biệt thự được thiết kế, decor theo phong cách hiện đại </p>

                    <h5>Thiết kế nội thất biệt thự Tân Cổ Điển </h5>
                    ...
                    <img className="img-wrapper" src="./assets/img-thicong/bt3.jpg"></img>
                    ...
                    <p className="text-center">Nội thất phòng bếp biệt thự được thiết kế theo phong cách Tân cổ điển</p>
                    <img className="img-wrapper" src="./assets/img-thicong/np7.jpg"></img>
                    <p className="text-center">Phòng Ngủ biệt thự được thiết kế theo phong cách Tân cổ điển</p>

                    <h5>Thiết kế nội thất biệt thự Cổ Điển </h5>
                    ...
                    <h4><strong>Báo giá thi công nội thất biệt thự trọn gói mới nhất:</strong></h4>
                    <p>Tùy thuộc vào phong cách thiết kế nội thất mà bảng giá thiết kế thi công biệt thự sẽ thay đổi. Sau đây là bảng giá theo phong cách thiết kế bạn có thể tham khảo:</p>
                    <div>
                    ...
                    <img className="img-wrapper" src="./assets/img-thicong/bt4.jpg"></img>
                </div>
