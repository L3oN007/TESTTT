...
export default function ConfirmBaoGiRequestCustomer() {
  ...
  useEffect(() => {
    ...
    axios.get(`https://65e4119b3070132b3b242651.mockapi.io/api/InteriorDesignArticle/IDACustomerSubmit/13`)
      .then(response => {
        const { customerName, phoneNumber, projectAddress, quotationDate, products } = response.data;
        // Update the state variables with the fetched data
        setCustomerName(customerName);
        setPhoneNumber(phoneNumber);
        setProjectAddress(projectAddress);
  ...
  function handleSubmit() {
    ...
    axios.put('https://65e4119b3070132b3b242651.mockapi.io/api/InteriorDesignArticle/IDACustomerSubmit/13', dataToSend)
      .then(response => {
