...
//     describe:
//       "Bộ sofa da phòng khách mang đến sự thoải mái và phong cách hiện đại. Với da cao cấp và khung thép chắc chắn, nó là lựa chọn lý tưởng cho không gian tiếp khách hoặc phòng khách gia đình.",
...
//     describe:
//       "Đèn chùm trần phòng ngủ mang lại không gian ấm áp và lãng mạn. Với thiết kế hiện đại và ánh sáng dịu dàng, nó tạo điểm nhấn cho bất kỳ phòng ngủ nào.",
...
//     describe:
//       "Tủ kệ gỗ sồi đa năng giúp tối ưu hóa không gian lưu trữ và trang trí trong phòng khách hoặc phòng ngủ. Với các ngăn kéo và kệ đa dạng, nó là lựa chọn hoàn hảo cho những ai đòi hỏi sự tiện ích và đẹp mắt.",
...
//     describe:
//       "Bộ gối sofa họa tiết hình học mang đến sự tươi mới và phong cách cho không gian nghỉ ngơi của bạn. Với các màu sắc sắc nét và chất liệu vải bền, chúng tạo điểm nhấn cho bất kỳ sofa nào.",
...
//     describe:
//       "Bàn ăn được làm từ gỗ sồi Mỹ chất lượng cao, mang phong cách đồng quê mộc mạc. Thiết kế đơn giản nhưng đầy tính nghệ thuật, làm tôn lên vẻ đẹp tự nhiên trong không gian phòng ăn.",
...
//     name: "Đèn Bàn Matin",
//     describe:
//       "Chiếc đèn bàn Matin của Inga Sempé nở hoa với các mẫu hoa. Cái bóng sứ tinh tế lan tỏa ánh sáng ấm áp, tạo ra một bầu không khí ấm cúng. Rất phù hợp để đặt trên bàn đầu giường hoặc góc đọc sách.",
//     size: { radius: "50cm" },
//     unit: "1",
//     mass: " 3kg",
...
//     describe:
//       "Thảm đỏ mềm mại với màu đỏ tươi sáng, làm nổi bật không gian sảnh hoặc phòng khách. Chất liệu cao cấp và độ dày vừa phải tạo cảm giác êm dịu khi đi trên thảm.",
...
//     name: "Kệ Đựng TV ",
//     describe:
//       "Kệ đựng TV đa năng với màu sắc hiện đại và thiết kế đơn giản nhưng tiện ích. Phù hợp với các không gian phòng khách nhỏ gọn và hiện đại.",
